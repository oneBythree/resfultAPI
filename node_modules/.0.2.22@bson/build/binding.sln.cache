<Project DefaultTargets="Build" ToolsVersion="2.0" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{7FE5D85B-ED50-C5E2-7613-D5A3B2CBBBC8}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{7FE5D85B-ED50-C5E2-7613-D5A3B2CBBBC8}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bson" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\bson.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\bson.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  <Target Name="bson:Clean" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\bson.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\binding.sln" Clean="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\bson.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\binding.sln" Clean="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  <Target Name="bson:Rebuild" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\bson.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\binding.sln" Rebuild="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\bson.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="E:\mydir\RESTful\node_modules\.0.2.22%40bson\build\binding.sln" Rebuild="true" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
